...
setwd("D:/xxiong/program/network/federated learning/paper/Simulation/xin new sim")
source('gen_Data.R')
source('local_xin.R')
source('local_xin_helper.R')
source('inte_xin.R')
source('inte_xin_helper.R')
source('IPD_xin.R')
source('IPD_xin_helper.R')
set.seed(123)
